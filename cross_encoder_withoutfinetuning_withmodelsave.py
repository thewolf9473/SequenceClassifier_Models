# -*- coding: utf-8 -*-
"""Cross-encoder-withoutfinetuning-withmodelsave.ipynb
...
pickle.dump(classifier,open('crossclassifier.sav','wb'))
...
def main():
    ...
    classifier = pickle.load(open('crossclassifier.sav','rb'))
